    ...
    <main className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-4">
        ...
        <motion.p 
          ...
          className="text-lg md:text-2xl mt-4 text-gray-400">
      ...
      <section className="px-6 py-12 bg-gray-950">
        ...
        <div className="bg-gray-900 border border-gray-700 max-w-3xl mx-auto rounded-2xl shadow-xl">
          <div className="p-6">
            <h3 className="text-xl font-bold">Software Developer – ECG, Inc.</h3>
            <p className="text-sm text-gray-400 mb-4">May 2023 – June 2025</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-xl">
            <div className="p-6">
              ...
              <p className="text-gray-400">JavaScript, TypeScript, Java, Python, Swift, C++</p>
              <p className="text-gray-400">React, Angular, Spring Boot, Node.js, CSS</p>
              <p className="text-gray-400">MongoDB, MySQL, Docker, Kubernetes, CI/CD</p>
            </div>
          </div>
          <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-xl">
            <div className="p-6">
              <h3 className="text-xl font-bold mb-4">Education</h3>
              <p className="text-gray-400">B.S. in Computer Science – SNHU (2025)</p>
              <p className="text-gray-400">M.S. in Computer Science – GA Tech (2027)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contact */}
      <section className="px-6 py-12 bg-gray-950 text-center">
        <h2 className="text-3xl font-semibold mb-6">Get in Touch</h2>
        <p className="text-gray-400 mb-4">📧 iarepsher@gmail.com</p>
        <p className="text-gray-400 mb-4">📍 New York, NY</p>
        <a href="https://linkedin.com/in/ianrepsher" className="text-blue-400 hover:underline">LinkedIn</a>
      </section>
    </main>
  );
}
