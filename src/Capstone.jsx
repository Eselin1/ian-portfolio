      ...
      <header className="max-w-6xl mx-auto px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <button
            ...
            className="px-5 py-2.5 border border-gray-300 dark:border-zinc-600 rounded-lg font-medium hover:bg-sage hover:text-white hover:border-transparent transition-colors"
          >
            Self-Assessment
          </button>
          <button
