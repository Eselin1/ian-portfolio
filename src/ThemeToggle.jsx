...
export default function ThemeToggle() {
  ...
  return (
    <motion.button
      onClick={toggleTheme}
      className="fixed top-1/2 right-4 z-50 p-2 rounded-full bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300"
